...
<%@include  file="default1.jsp" %>
		...
		<div id="centerdiv">
			...
			<br><h3> Fee Due List </h3>
					<hr><br>
				<form action="FeeDueListPlaceWise" method="post" target="_blank">
					<table border="1">

							<s:select label = "Select Place" list="PlaceList"  id="selectedList" name="Place" value="defaultClass" required="required"></s:select>
