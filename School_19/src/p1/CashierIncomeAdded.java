...
public class CashierIncomeAdded 
{
	private String description,IncomeType;
	...
	try 
	{
		...
		ps = con.prepareStatement("insert into incomes (type,date,time,amount,description,cashier) values(?,?,?,?,?,?)");
