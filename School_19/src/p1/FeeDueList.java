...
public class FeeDueList 
{
	...
	public String execute() 
	{
		try 
		{
			...
			ps2= con.prepareStatement("select admn,name,place,duefrom,outstanding,transduefrom,admfees,annfees,mob,tutiondisc,transdisc from students where class = ? order by name");
